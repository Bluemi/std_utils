...
echo -e "installing ${GREEN}$SCRIPT_NAME-wrapper${NC}"

mkdir -p $HOME/.local/bin

SOURCE_PATH="$PWD/xournal-wrapper.sh"
...
echo -e "  ${GREEN}SUCCESS:${NC} finished ${GREEN}$SCRIPT_NAME-wrapper${NC} installation"
